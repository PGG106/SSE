...
#define fflush fflushbla
inline static void fflush(int fd) {
    
}

#define strcmp strcmpbla
...
#define memset memsetbla

void* memset(void* ptr, int value, size_t n);

#define log logbla
inline static double log(double x) {
    const int SQRT1_2 = 0.7071067811865476;
    const int SQRT2 = 1.4142135623730951;
